...
/***/ "./src/declarations/Site5/Site5.did.js":
/*!*********************************************!*\
  !*** ./src/declarations/Site5/Site5.did.js ***!
  \*********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/declarations/Site5/index.js":
/*!*****************************************!*\
  !*** ./src/declarations/Site5/index.js ***!
  \*****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "idlFactory": () => (/* reexport safe */ _Site5_did_js__WEBPACK_IMPORTED_MODULE_1__.idlFactory),
/* harmony export */   "canisterId": () => (/* binding */ canisterId),
/* harmony export */   "createActor": () => (/* binding */ createActor),
/* harmony export */   "Site5": () => (/* binding */ Site5)
/* harmony export */ });
...
/* harmony import */ var _Site5_did_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Site5.did.js */ "./src/declarations/Site5/Site5.did.js");
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./Site5.did.js")._SERVICE>}
 */
 const createActor = (canisterId, options) => {
  ...
  return _dfinity_agent__WEBPACK_IMPORTED_MODULE_0__.Actor.createActor(_Site5_did_js__WEBPACK_IMPORTED_MODULE_1__.idlFactory, {
    agent,
    canisterId,
...
/**
 * A ready-to-use agent for the Site5 canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./Site5.did.js")._SERVICE>}
 */
 const Site5 = createActor(canisterId);
...
"use strict";
/*!***************************************!*\
  !*** ./src/Site5_assets/src/index.js ***!
  \***************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _declarations_Site5__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../declarations/Site5/index.js */ "./src/declarations/Site5/index.js");
/* harmony import */ var _dfinity_principal__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @dfinity/principal */ "./node_modules/@dfinity/principal/lib/esm/index.js");
// 引用后端的Canister
...
async function post(){
  ...
  try {
    await _declarations_Site5__WEBPACK_IMPORTED_MODULE_0__.Site5.post(otp, text);
    textarea.value = "";
  } catch (err) {
    console.log(err)
...
async function follow(){
  ...
  let text = textarea.value;
  try {
    await _declarations_Site5__WEBPACK_IMPORTED_MODULE_0__.Site5.follow(otp, _dfinity_principal__WEBPACK_IMPORTED_MODULE_1__.Principal.fromText(text));
    textarea.value = "";
  } catch (err) {
    console.log(err)
...
async function load_follows() {
  ...
  follows = await _declarations_Site5__WEBPACK_IMPORTED_MODULE_0__.Site5.follows();
  ...
  for (var i=0; i < follows.length; i++) {
    ...
    let actor = (0,_declarations_Site5__WEBPACK_IMPORTED_MODULE_0__.createActor)(follows[i]);
...
async function load_timeline(){
  ...
  let timeline = await _declarations_Site5__WEBPACK_IMPORTED_MODULE_0__.Site5.timeline(0);
